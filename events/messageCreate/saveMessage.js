...
module.exports = async (message) => {
    try {
        ...
        if (guildSaveUsed) {
            ...
            const guildSaveMessage = `${adminRole} ${modRole} ${user.username} (${user.id}) used a guild save! I locked the channel from the counting role but please check the channel asap to see if someone is trying to ruin our count.`;
